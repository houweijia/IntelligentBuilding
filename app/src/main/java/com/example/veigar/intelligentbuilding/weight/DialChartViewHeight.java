...
public class DialChartViewHeight extends GraphicalView {
	...
	public DialChartViewHeight(Context context) {
		super(context);
		initView();
	}

	public DialChartViewHeight(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public DialChartViewHeight(Context context, AttributeSet attrs, int defStyle) {
	...
	public void chartRender() {
		try {
			...
			// 设置指针长度
			chart.getPointer().setLength(0.01f);
