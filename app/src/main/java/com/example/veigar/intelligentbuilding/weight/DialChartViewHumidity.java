...
public class DialChartViewHumidity extends GraphicalView {
	...
	public DialChartViewHumidity(Context context) {
		super(context);
		initView();
	}

	public DialChartViewHumidity(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public DialChartViewHumidity(Context context, AttributeSet attrs, int defStyle) {
