...
public class DialChartViewPM extends GraphicalView {
	...
	public DialChartViewPM(Context context) {
		super(context);
		initView();
	}

	public DialChartViewPM(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public DialChartViewPM(Context context, AttributeSet attrs, int defStyle) {
