...
public class DialChartViewVoltage extends GraphicalView {
	...
	public DialChartViewVoltage(Context context) {
		super(context);
		initView();
	}

	public DialChartViewVoltage(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public DialChartViewVoltage(Context context, AttributeSet attrs, int defStyle) {
	...
	public void addAxis() {
		...
		for (int i = 0; i <= 50;) {
			...
			rlabels.add(Integer.toString(i)+"V");
		...
		for (int i = 0; i <= 50; i+=10) {
			rlabels2.add(Integer.toString(i) + "V");
		}
